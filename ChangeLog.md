...
* Poky 3.1.10 and updates to meta-openembedded & meta-rtlwifi.

* Update u-boot-bbe to v2021.07-sc1 and replace custom boot script with an
  extlinux.conf file generated by Yocto.
